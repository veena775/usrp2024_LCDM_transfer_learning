...
##################################### INPUT ##########################################
# data parameters
cosm_type = 'BSQ' #'nwLH' or 'LH'
Pk_type = 'MPk'
n_sims = 32000
name = 'transfer10_network1_'+str(n_sims)
...
f_params  = '../real_params/' +str(n_sims) +'_'+ str(cosm_type)+'_params.txt' 
# f_Pk      = 'all_'+str(Pk_type)+'_'+str(cosm_type)+'_fhl500_fortransfer.npy'
