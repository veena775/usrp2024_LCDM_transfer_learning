...
class Objective(object):
    def __init__(self, input_size, output_size, max_layers, max_neurons_layers, device, 
                 epochs, seed, batch_size, final_hidden_layer_size, max_epochs_no_improvement=50):
        ...
        self.mother = '/scratch/network/vk9342/USRP2024_scratch/pytorch/MPk_nwLH/transfer5_network2/'
...
f_Pk      = 'all_MPk_nwLH_fortransfer.npy'
f_params  = '../real_params/latin_hypercube_params_nwLH.txt' 
study_name       = 'MPk_nwLH_params_transfer5_network2'   #+str(epochs)
output_size        = 7
