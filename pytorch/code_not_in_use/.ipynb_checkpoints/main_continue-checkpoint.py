...
class Objective(object):
    def __init__(self, input_size, output_size, max_layers, max_neurons_layers, device, 
        ...
        self.mother = '/scratch/network/vk9342/USRP2024/pytorch/Pk_nwLH/transfer_497/'
...
#     study_name       = 'Pk_nwLH_params_transfer_497'   #+str(epochs)
#     output_size        = 7

# elif cosm_type == 'LH':
#     f_Pk      = 'all_Pk_LH.npy'
#     f_params  = '../real_params/latin_hypercube_params.txt' 
#     study_name       = 'Pk_LH_params_dynamic'   #+str(epochs)
#     output_size        = 5
# else:
#     print('specify type')


f_Pk      = 'all_Pk_nwLH_497.npy'
f_params  = '../real_params/latin_hypercube_params_nwLH.txt' 
study_name       = 'Pk_nwLH_params_transfer_497'   #+str(epochs)
output_size        = 7
f_Pk_norm = None
...
objective = Objective(input_size, output_size, max_layers, max_neurons_layers, 
                      device, epochs, seed, batch_size, max_epochs_no_improvement=50)
