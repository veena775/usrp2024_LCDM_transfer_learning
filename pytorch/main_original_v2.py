...
import data_original, architecture
import optuna
...
class Objective(object):
    ...
    def __call__(self, trial):
        ...
        # get the data
        train_loader = data_original.create_dataset('train', self.seed, f_Pk, f_Pk_norm, 
                                           f_params, self.batch_size, shuffle=True, workers=1)
        valid_loader = data_original.create_dataset('valid', self.seed, f_Pk, f_Pk_norm, 
