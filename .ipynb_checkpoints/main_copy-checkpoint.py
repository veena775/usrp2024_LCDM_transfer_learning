...
n_sims = 25
n_sims_BSQ = 4000
name = 'transfer10_network2_'+str(n_sims)+'_'+cosm_type+'_'+str(n_sims_BSQ)+'_BSQ'
...
# f_Pk      = 'Pk_files/'+str(n_sims)+'_'+str(Pk_type)+'_'+str(cosm_type)+params_ext+'.npy'
f_params  = '../real_params/'+str(n_sims) +'_'+ str(cosm_type)+'_'+str(Pk_type)+'_params'+params_ext+'.txt' 

extension = 'fhl10'
f_Pk      = 'Pk_files/'+str(n_sims)+'_'+cosm_type+'_'+str(n_sims_BSQ)+'_BSQ_'+Pk_type+params_ext+'_'+str(extension)+'_fortransfer.npy'
