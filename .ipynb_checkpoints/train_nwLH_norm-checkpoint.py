...
# np.save('training_nums_nwLH_norm', training_nums)

# testing_nums = []
# for i in range (2000):
#     if i not in training_nums:
#         testing_nums.append (i)
# np.save('testing_nums_nwLH_norm', testing_nums)

# print(len(training_nums), len(testing_nums))
...
std_Pk = np.std(Pk, axis  = 0)
print(len(std_Pk))
mean_Pk = np.std(Pk, axis = 0)
print (len(mean_Pk))


print(Pk.shape)
Pk = (Pk - mean_Pk) / std_Pk
...
posterior_file_name = 'posterior_nwLH_norm_1800_'+str(k_max)+'.pth'
