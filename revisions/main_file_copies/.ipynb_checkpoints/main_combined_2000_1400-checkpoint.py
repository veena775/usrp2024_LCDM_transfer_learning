...
if __name__ == "__main__":
    ...
    # data parameters
    cosm_type = 'nwLH' #'nwLH' or 'LH' or 'LC'
    ...
    f_Pk_valid      = 'Pk_files/'+Pk_type+'_'+str(n_sims)+'_'+cosm_type+'_'+str(n_sims_BSQ)+'_BSQ_combined_valid.npy'
    f_params_valid  = 'real_params/'+Pk_type+'_'+str(n_sims)+'_'+cosm_type+'_'+str(n_sims_BSQ)+'_BSQ_combined_params_valid.txt'
